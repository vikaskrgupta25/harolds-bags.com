    ...
    if (results && results.length > 0) {
      $.each(results, function(index, result) {
        ...
        if (result['price']) {
          ...
          link.append('<div class="search-title">' + result.title + '<br><span class="item-pricing price money" data-product-id="'+result.id+'">'+ itemPrice +'</span></div>');
...
$('.js-related-products-slider').flickity({
  // options
  cellAlign: 'left',
  autoPlay: false,
  freeScroll: true,
